                ...
                <div class="col-lg-6">
                    <div class="d-flex align-items-center flex-wrap">
                        <ol class="breadcrumb">
                            ...
                            <li>الكويت اليوم</li>
                            <li>تعديل العدد رقم {{$versionID->versionno}}</li>
                        </ol>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row mt-0">
                <div class="col-lg-12 tbl-new-brdr">
                    <div class="panel panel-default no-brdr">
                        <form action="{{route('updateVersion',['version'=>$versionID])}}" method="POST"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="versionType" id="versionType" dir="rtl" class="SelectWithSearch"
                                            ...
                                            <option dir="rtl" value="عدد اساسى"
                                                    @if($versionID->versiontype == "عدد اساسى")selected @endif
                                            >عدد اساسى
                                            </option>
                                            <option dir="rtl" value="ملحق"
                                                    @if($versionID->versiontype == "ملحق")selected @endif
                                            >ملحق
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="num" name="versionNo" id="versionNo" lang="en" class="form-control"
                                               placeholder=" رقم العدد" required
                                               value="{{old('versionNo')??$versionID->versionno}}" dir="rtl">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>تاريخ النشر بالجريدة الرسمية</label>
                                        <input type="date" class="form-control" name="versionDate" id="versionDate"
                                               value="{{old('versionDate')??$versionID->versiondate}}" required>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 float-right overflow-auto" style="height: 650px;overflow-y: scroll;">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio"
                                               onclick="openFile({{json_encode($versionID->versionfile)}},'KuwaitAlyoum_finished')"
                                               name="versionFile"
                                               id="versionFile" value="{{$versionID->versionfile}}">
                                        {{$versionID->versionfile}}
                                    </label>
                                </div>
                            </div>
                        </form>
